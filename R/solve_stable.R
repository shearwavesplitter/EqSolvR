...
#' export
stable.htes <- function(Tc=300,Nat=0.2,Kt=0.2,Clt=0.4,SO4t=0.2,Cat=0.1,Mgt=0.1,start=c(0.00001,0.00001,0.15,0.15,0.15,0.104756881,0.05,0.05),maxitr=100){
	...
	z1 <- 1; z2 <- -1; z3 <- -1; z4 <- 1; z5 <- 1; z6 <- -2;z7 <- 2; z8 <- 2; z9 <- -1; z10 <- -1; z11 <- -1; z12 <-0; z13 <-0; z14 <-0; z15 <-0; z16 <- 0; z17 <-0; z18 <-0; z19 <-1; z20 <-1; z21 <-0; z22 <-1; z23 <-1;
